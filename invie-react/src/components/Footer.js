...
import logoWhite from '../assets/images/invie-white.png';
  ...
  render() {
    ...
    return (
      ...
      <div className="contenedor">
        ...
        <form className="formulario"> {/* ClassName */}
          <div className="col1">
            <label htmlFor="nombre">Nombre</label>
            <input type="text" required id="nombre" name="nombre"/> {/* htmlFor otro atributo porque el for es palabra reservada */}
            <label htmlFor="email">E-mail</label>
            <input type="email" required id="email" name="email"/>
            <div className="sexo">
              <label htmlFor="mujer">
                <input type="radio" id="mujer" defaultChecked name="sexo" value="mujer" /> mujer {/* defaultChecked */}
              </label>
